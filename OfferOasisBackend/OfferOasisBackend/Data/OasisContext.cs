    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Product>()
            .HasData(
                ...
                new Product(4, "Designer Watch", ProductType.Monitor, 199, 30,
                ...
                new Product(5, "Bluetooth Speaker", ProductType.Console, 79, 20,
        ...
        // builder.Entity<OrderDetails>()
        //     .HasData(new OrderDetails(1,1,1,10, 2000));
        ...
        {
            b.HasMany<OrderDetails>().WithOne().HasForeignKey(o => o.OrderId).IsRequired();
        });
        
        builder.Entity<Product>(b =>
        {
            b.HasMany<OrderDetails>().WithOne().HasForeignKey(o => o.ProductId).IsRequired();
        });
