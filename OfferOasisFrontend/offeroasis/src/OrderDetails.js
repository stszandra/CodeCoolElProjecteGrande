...
export default function OrderDetails() {
    ...
    <span className=" text-transparent bg-clip-text bg-gradient-to-r to-green-900 from-red-900">Dear</span> valued customer,
               ...
               <div className='w-1/2'>
               <img src="https://cdn.smartkarrot.com/wp-content/uploads/2020/09/Satisfied-Customers.png" className="h-56 w-100 ml-16 border-double rounded-full"  />
                 </div>
               </div>
               </div>
            )}
            <div className="flex" > 
               ...
               <div className="flex" > 
               <div className='w-1/3'>
              <img src='https://presta.hu/32-large_default/foxpost.jpg '  className="h-56 w-100  border-double rounded-2xl mt-11 ml-48"/>
                </div>
               <div className='w-1/3'>
               <img src="https://www.gls-us.com/getmedia/c1a108d8-d659-4389-81ff-e80f8968b58a/Medium-GLS_Logo_2021_CMYK-GLSBlue_-FreightDescriptor_English.jpg " className="h-56 w-100 ml-16 border-double rounded-2xl mt-11"  />
                 </div>
                 <div>
                 <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/United_Parcel_Service_logo_2014.svg/1200px-United_Parcel_Service_logo_2014.svg.png' class="h-56 w-100 ml-24 border-double rounded-2xl mt-11"/>
                 </div>
               </div>
