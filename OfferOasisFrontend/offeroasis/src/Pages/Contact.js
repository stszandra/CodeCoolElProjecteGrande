          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              <div className="p-2 w-1/2">
                <div className="relative">
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full bg-gray-500 rounded border border-gray-300 focus:border-indigo-500 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                  />
                </div>
              </div>
              <div className="p-2 w-1/2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <div className="text-black-500">offeroasis@offeroasis.com</div>
